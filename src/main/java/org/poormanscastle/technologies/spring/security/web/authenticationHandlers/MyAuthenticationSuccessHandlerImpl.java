 ...
 */
public class MyAuthenticationSuccessHandlerImpl extends SimpleUrlAuthenticationSuccessHandler {
    ...
    public MyAuthenticationSuccessHandlerImpl(String defaultTargetUrl) {
        super(defaultTargetUrl);
    }

    public MyAuthenticationSuccessHandlerImpl() {
    }
